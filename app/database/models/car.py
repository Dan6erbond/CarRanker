...
class Car(Base):
    ...
    type_full = db.Column(db.String(256), nullable=True)
    ...
    drive_type = db.Column(db.Enum(DriveType), nullable=True)
    mileage = db.Column(db.Integer, nullable=False)
    consumption_combined = db.Column(db.Float, nullable=True)
